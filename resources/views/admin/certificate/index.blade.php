...
<div class="container-fluid flex-grow-1 container-p-y">
	<h4 class="font-weight-bold py-3 mb-0">Certificate List ({{ count($datacountlists)}})</h4>
			...
			<div class="card">
				<div class="card-body">
					<div class="row align-items-center m-l-0">
						...
						<div class="col-sm-2 text-right">
						  <a href="{{ url('admin/certificate/create') }}" data-size="xl" class="btn btn-success btn-sm mb-3 btn-round"><i class="feather icon-plus"></i> Add certificate </a>
						</div>
					</div>
					<div class="row">
							...
							<table id="report-table" class="table table-bordered table-striped mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											@if($val->status=='1')<span class="badge badge-success">Active</span>@else<span class="badge badge-danger">Deactive</span>@endif
										</td>										
										<td>
											<a data-size="lg"  class="btn btn-icon btn-outline-primary" data-toggle="tooltip" title="View" href="{{ url('admin/certificate/view',$val->id) }}">
        ...
        for(i=0;i<element_lenght;i++)
        {
			if(formid.elements[i].name=="mul_del[]")
			{
				if(formid.elements[i].checked==true)
				{
					...
					{
						$("#formid").attr("action", "{{url('admin/certificate/delete')}}");
						this.formid.submit();
						break;
					}
				}	
