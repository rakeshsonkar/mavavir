...
<div class="container-fluid flex-grow-1 container-p-y">
	<h4 class="font-weight-bold py-3 mb-0">@lang('message.add_role')</h4>
	<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="feather icon-home"></i></a></li>
			<li class="breadcrumb-item"><a href="{{ route('admin.role.index') }}">@lang('message.role')</a></li>
			<li class="breadcrumb-item active">@lang('message.add_role')</li>
		</ol>
	</div>
						...
						<tbody>
								...
								<td>
									...
									<div class="row">
										<div class="col-md-3 custom-control custom-checkbox">
											<input class="custom-control-input" id="parent_permissions{{$parent_module->id}}" name="parent_permissions[]" type="checkbox" value="{{$parent_module->id}}">
											<label for="parent_permissions{{$parent_module->id}}" style="display:none;" class="custom-control-label font-weight-500"></label><br>
										</div>
									</div> 
								</td>
							</tr>
							@php $guard1=1;$guard2=1;$guard3=1;$guard4=1; @endphp
							...
							<tr>
								...
								<td>
									...
									<div class="row">
										<div class="col-md-3 custom-control custom-checkbox" >
											<input class="custom-control-input" id="child_privilege{{$sub_module->id}}" name="can_manage[{{$parent_module->id}}][{{$sub_module->id}}]" type="checkbox" value="1">
										...
										<div class="col-md-2 custom-control custom-checkbox">
											<input class="custom-control-input" id="guard_permission1{{$guard1}}" name="can_create[{{$parent_module->id}}][{{$sub_module->id}}]" type="checkbox" value="1">
											<label for="guard_permission1{{$guard1}}" class="custom-control-label font-weight-500">Create</label><br>
										</div>
										<div class="col-md-2 custom-control custom-checkbox">
											<input class="custom-control-input" id="guard_permission2{{$guard2}}" name="can_edit[{{$parent_module->id}}][{{$sub_module->id}}]" type="checkbox" value="1">
											<label for="guard_permission2{{$guard2}}" class="custom-control-label font-weight-500">Edit</label><br>
										</div>
										<div class="col-md-2 custom-control custom-checkbox">
											<input class="custom-control-input" id="guard_permission3{{$guard3}}" name="can_view[{{$parent_module->id}}][{{$sub_module->id}}]" type="checkbox" value="1">
											<label for="guard_permission3{{$guard3}}" class="custom-control-label font-weight-500">View</label><br>
										</div>            
										<div class="col-md-2 custom-control custom-checkbox">
											<input class="custom-control-input" id="guard_permission4{{$guard4}}" name="can_delete[{{$parent_module->id}}][{{$sub_module->id}}]" type="checkbox" value="1">
