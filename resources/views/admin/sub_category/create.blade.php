...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-0">@lang('message.create_sub_sub_category')</h4>
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('message.create_sub_sub_category')</li>
        </ol>
    </div>
    <div class="row">
            ...
            <div class="col-md-12">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="account-general">
                    	<form role="form" action="{{ url('admin/sub_category/store') }}" method="POST" enctype="multipart/form-data" autocomplete="off"> 
