...
<div class="container-fluid flex-grow-1 container-p-y">
	<h4 class="font-weight-bold py-3 mb-0">@lang('message.seo_list') ({{ count($datacountlists)}})</h4>
				...
				<div class="card-body">
					<div class="row align-items-center m-l-0">
						...
						<!-- <div class="col-sm-2 text-right">
						  <a href="{{ url('admin/seo/export') }}" data-size="xl" class="btn btn-warning btn-sm mb-3 btn-round"><i class="feather"></i> Export</a>
						</div> -->
						...
						<div class="col-sm-2 text-right">
						  <a href="{{ url('admin/seo/create') }}" data-size="xl" class="btn btn-success btn-sm mb-3 btn-round"><i class="feather icon-plus"></i> Add seo </a>
						</div>
							...
							<table id="report-table" class="table table-bordered table-striped mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{ $val->page_url }}</td>
										<td>
											<a data-size="lg"  class="btn btn-icon btn-outline-success" data-toggle="tooltip" title="Edit" href="{{ url('admin/seo/edit',$val->id) }}">
												<i class="feather icon-edit"></i>
											</a>
											<a data-size="lg"  class="btn btn-icon btn-outline-primary" data-toggle="tooltip" title="View" href="{{ url('admin/seo/view',$val->id) }}">
        ...
        for(i=0;i<element_lenght;i++)
        {
			if(formid.elements[i].name=="mul_del[]")
			{
				if(formid.elements[i].checked==true)
				{
					...
					{
						$("#formid").attr("action", "{{url('admin/seo/delete')}}");
						this.formid.submit();
						break;
					}
				}	
