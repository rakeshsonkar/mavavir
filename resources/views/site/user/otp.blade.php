...
<meta name='description' content='Compare insurance policies offered by various insurers in India & buy insurance policy online. Get instant quotes & save huge on premiums.' />
    ...
    <body>
										...
										<ul class="language-item-bottom">
											<li class="language-item">
												<a href="#" class="language-link">
													<img src="{{ asset('site/assets/img/language/english.png') }}" alt="Image">
													English
												</a>
											</li>
											<li class="language-item">
												<a href="#" class="language-link">
													<img src="{{ asset('site/assets/img/language/arab.png') }}" alt="Image">
													العربيّة
												</a>
											</li>
											<li class="language-item">
												<a href="#" class="language-link">
													<img src="{{ asset('site/assets/img/language/germany.png') }}" alt="Image">
													Deutsch
												</a>
											</li>
											<li class="language-item">
												<a href="#" class="language-link">
													<img src="{{ asset('site/assets/img/language/portugal.png') }}" alt="Image">
													󠁥󠁮󠁧󠁿Português
												</a>
											</li>
											<li class="language-item">
												<a href="#" class="language-link">
													<img src="{{ asset('site/assets/img/language/china.png') }}" alt="Image">
													简体中文
												</a>
											</li>
										</ul>
		...
		<div class="page-title-area bg-19">
			<div class="container">
				<div class="page-title-content">
					<h2 style="color: red;">OTP Verify</h2>
					<ul>
						<li>
							<a href="{{ route('site.home.index') }}">
								Home 
		...
		<section class="user-area-style ptb-100">
			<div class="container">
				<div class="contact-form-action">
					<div class="account-title">
						<h2 style="color: red; text-align: center;">Otp Verify</h2>
					</div>
          <div class="row">
          ...
          <form role="form" action="{{ url('user/register/otpVerify') }}" method="post" enctype="multipart/form-data" autocomplete="off"> 
          ...
          <div class="row">
							 <div class="col-12">
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" name="otp" minlength="3" maxlength="6">
								</div>
							</div>
                            </div>
							...
							<div class="contact-form-action">
								...
								<form method="post">
									<div class="row">
										...
										<div class="col-12">
											<p>Have an account? <a href="register.html">Registration Now!</a></p>
										</div>
									</div>
								</form>
							</div>
							...
							<div class="contact-form-action">
								...
								<form method="post">
									<div class="row">
										...
										<div class="col-12">
											<p>Have an account? <a href="{{ route('site.user.login') }}">Login now!</a></p>
										</div>
									</div>
								</form>
							</div>
